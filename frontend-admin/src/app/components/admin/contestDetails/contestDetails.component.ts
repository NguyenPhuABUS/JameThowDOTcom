...
@Component({
  ...
  host: { 'collision-id': 'ContestDetailsComponent' },
...
export class ContestDetailsComponent implements OnInit {
  ...
  selectedContent: ContestEntries;
  ...
  ngOnInit() {
    ...
    this.activatedRoute.paramMap.subscribe(p => {
      ...
      this.contestEntriesService.findBycontentId(contestId).then(
        res => {
  ...
  showDetailDialog(contestEntries: ContestEntries) {
    this.selectedContent = contestEntries;
